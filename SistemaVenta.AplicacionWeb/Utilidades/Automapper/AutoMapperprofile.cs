...
namespace SistemaVenta.AplicacionWeb.Utilidades.Automapper
{
    public class AutoMapperprofile: Profile
    {
        public AutoMapperprofile()
        {
            ...
            //    .ForMember(destino =>
            //    destino.PorcentajeImpuesto,
            //    opt => opt.MapFrom(origen => Convert.ToDecimal(origen.PorcentajeImpuesto, new CultureInfo("es-MXN")))
            //    );
            ...
            //    .ForMember(destino =>
            //    destino.Precio,
            //    opt => opt.MapFrom(origen => Convert.ToString(origen.Precio.Value, new CultureInfo("es-MXN")))
            //    );
            ...
            //    .ForMember(destino =>
            //    destino.Precio,
            //    opt => opt.MapFrom(origen => Convert.ToDecimal(origen.Precio, new CultureInfo("es-MXN")))
            //    );
