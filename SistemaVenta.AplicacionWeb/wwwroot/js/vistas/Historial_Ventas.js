...
$("#btnBuscar").click(function () {
    ...
    fetch(`/NuevaVenta/Historial?numeroVenta=${numeroVenta}&fechaInicio=${fechaInicio}&fechaFin=${fechaFin}`)
        .then(response => {
...
$("#tbventa tbody").on("click", ".btn-info", function () {
    ...
    $("#txtDocumentoCliente").val("Boleta")
    ...
    $("#linkImprimir").attr("href", `/NuevaVenta/MostrarPDFVenta?numeroVenta=${d.numeroVenta}`)
