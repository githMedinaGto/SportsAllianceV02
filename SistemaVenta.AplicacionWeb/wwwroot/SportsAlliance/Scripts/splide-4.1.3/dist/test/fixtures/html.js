 ...
 * @return A built HTML.
 */
export function generateSlides(length, src, dataSrc, dataSrcset, dataInterval = []) {
    return Array.from({ length }).reduce((html, item, index) => {
        ...
        if (dataSrcset) {
            imgAttrs.push(`${SRCSET_DATA_ATTRIBUTE}="${URL}/${typeof dataSrcset === 'string' ? dataSrcset + '-' : ''}${index}.jpg 320w"`);
        }
...
`;
//# sourceMappingURL=../../../src/js/test/fixtures/html.js.map