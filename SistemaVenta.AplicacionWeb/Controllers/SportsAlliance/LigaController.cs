...
namespace SistemaVenta.AplicacionWeb.Controllers.SportsAlliance
{
    ...
    public class LigaController : Controller
    {
        ...
        #region Obtener la tabla equipos
        [HttpPost]
        public String TablaEquipos(int idLiga)
        {
            string sTabla = "";
            string sIdTabla = "";
            string[] aColumnas = new string[] { "NOMBRE", "Color", "Codigó", "Liga", "Deporte", "Director Tecnico" };
        ...
        [HttpPost]
        public string LlenarComboDeDeportes()
        {
            string sRespuesta = "";
            ...
            {
                sRespuesta += "<option value='0' disabled>Elige un deporte</option>";
        ...
        #region Agregar Liga
        [HttpPost]
        public string InsertarLiga(string sNombre, int iDeporte, int iCategoria)
        {
            ConexionSQL cn = new ConexionSQL();
        ...
        #region Iniciar liga
        [HttpPost]
        public string IniciarLiga(int iIdLiga)
        {
            ...
            string sQueryIns = "";
            bool resutl = true;
            string numQuery = "select Count(iLiga) from [dbo].[tJornada]" +
                "\r\nwhere iLiga =" + iIdLiga;
        ...
        [HttpPost]
        public string FinPartido(int idPartido, int iGanador, int iGolLocal, int iGolVisitante)
        {
            ConexionSQL cn = new ConexionSQL();
            bool resutl = true;
            string sQuery = "UPDATE tJornada" +
                "\r\nSET [iGanador]= " + iGanador +
                "\r\n,[iGolesLocal] = " + iGolLocal +
                ",\r\n [iGolesVisitante]=" + iGolVisitante +
                "\r\nWHERE idJornada = " + idPartido;
