...
{
    public class ConexionDBVentaSQL
    {
        SqlConnection conex = new SqlConnection();


        string cadenaCOnexion = "Data Source=JONATHANMEDINA\\MSSQLSERVERLINUX; Initial Catalog=DBVENTA; Integrated Security=True";
